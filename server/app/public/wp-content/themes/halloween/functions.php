...
function get_characters($request) {
    $character_fields = array(get_fields(77), get_fields(61), get_fields(67), get_fields(58)); // the IDs correspond to the character pages. fields created using Advanced Custom Fields
